...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./css/app/base.scss */ 52);
	__webpack_require__(/*! ./css/app/menu.scss */ 54);
	__webpack_require__(/*! ./css/app/player.scss */ 56);
	__webpack_require__(/*! ./css/app/style.scss */ 60);
	...
	$(function(){
	    __webpack_require__(/*! ./scripts/routers/appRouter.js */ 62);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader!./../../~/sass-loader!./base.scss */ 53);
...
/* 53 */
/*!**********************************************************!*\
  !*** ./~/css-loader!./~/sass-loader!./css/app/base.scss ***!
  \**********************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader!./../../~/sass-loader!./menu.scss */ 55);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../~/style-loader/addStyles.js */ 4)(content, {});
	if(content.locals) module.exports = content.locals;
...
/* 55 */
/*!**********************************************************!*\
  !*** ./~/css-loader!./~/sass-loader!./css/app/menu.scss ***!
  \**********************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader!./../../~/sass-loader!./player.scss */ 57);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../~/style-loader/addStyles.js */ 4)(content, {});
	if(content.locals) module.exports = content.locals;
...
/* 57 */
/*!************************************************************!*\
  !*** ./~/css-loader!./~/sass-loader!./css/app/player.scss ***!
  \************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 58 */
/*!*********************************************************************!*\
  !*** ./scripts/libs/jquery-ui-local-customizations/player-icon.png ***!
  \*********************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 59 */
/*!*******************************************************************!*\
  !*** ./scripts/libs/jquery-ui-local-customizations/menu-icon.png ***!
  \*******************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader!./../../~/sass-loader!./style.scss */ 61);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../~/style-loader/addStyles.js */ 4)(content, {});
	if(content.locals) module.exports = content.locals;
...
/* 61 */
/*!***********************************************************!*\
  !*** ./~/css-loader!./~/sass-loader!./css/app/style.scss ***!
  \***********************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 62 */
/*!**************************************!*\
  !*** ./scripts/routers/appRouter.js ***!
  \**************************************/
/***/ function(module, exports, __webpack_require__) {

	var $ = __webpack_require__(/*! jquery */ 29);
	var Backbone = __webpack_require__(/*! backbone */ 30);
	var appModel = __webpack_require__(/*! ../models/app.js */ 63);
	var AppView = __webpack_require__(/*! ../views/app/app.js */ 64);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// subview: playerpanel
	var playerModel = __webpack_require__(/*! ../../models/player.js */ 65);
	var PlayerView = __webpack_require__(/*! ../../views/app/player.js */ 66);
	var playerView = new PlayerView({ model: playerModel, template: $("#template_player").html() });
	
	// subview: search
	var searchModel = __webpack_require__(/*! ../../models/search.js */ 67);
	var SearchView = __webpack_require__(/*! ../../views/app/search.js */ 68);
	var searchView = new SearchView({ model: searchModel, template: $("#template_search").html() });
	
	// subview: nav
	var navModel = __webpack_require__(/*! ../../models/nav.js */ 69);
	var NavView = __webpack_require__(/*! ../../views/app/nav.js */ 70);
